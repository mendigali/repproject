    ...
    <div class="main">
        ...
        <div class="content">
            <div class="content_blog">
                                    ...
                                    <div class="del_edit">
                                        <div class="delete">
                                            <form action="temirizmeni.php" method="post">
                                                <input class="edit_img" type="image" src="../../../images/admin/blog/edit.png">
                                            </form>
                                        </div>
                                        <div class="edit">
                                            <form action="temirizmeni.php" method="post">
                                                <input class="delete_img" type="image" src="../../../images/admin/blog/delete.png">
                                            </form>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="add_blog">
                    <a href="#"><img class="add_img" src="../../../images/admin/blog/add.png"></a>
                </div>
            </div>
        </div>
    </div>
